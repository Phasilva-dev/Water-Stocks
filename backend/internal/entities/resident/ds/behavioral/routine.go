// Package behavioral define estruturas de dados para armazenar informações de comportamento
// relacionadas a residentes, como rotina diaria de presença em casa
package behavioral
