...
func (f *ResidentDeviceProfiles) FreqToilet() *FrequencyProfile { return f.freqToilet }

// FreqShower retorna o perfil de frequência para chuveiro. Pode ser nil.
func (f *ResidentDeviceProfiles) FreqShower() *FrequencyProfile { return f.freqShower }

// FreqWashBassin retorna o perfil de frequência para lavatório. Pode ser nil.
func (f *ResidentDeviceProfiles) FreqWashBassin() *FrequencyProfile { return f.freqWashBassin }

// FreqWashMachine retorna o perfil de frequência para máquina de lavar roupas. Pode ser nil.
func (f *ResidentDeviceProfiles) FreqWashMachine() *FrequencyProfile { return f.freqWashMachine }

// FreqDishWasher retorna o perfil de frequência para lava-louças. Pode ser nil.
func (f *ResidentDeviceProfiles) FreqDishWasher() *FrequencyProfile { return f.freqDishWasher }

// FreqTanque retorna o perfil de frequência para tanque. Pode ser nil.
func (f *ResidentDeviceProfiles) FreqTanque() *FrequencyProfile { return f.freqTanque }
...
func (f *ResidentDeviceProfiles) GenerateData(rng *rand.Rand) *behavioral.Frequency {
